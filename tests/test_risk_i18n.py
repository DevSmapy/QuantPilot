...
def test_scoring_unchanged_by_locale_labels() -> None:
    ...
    assert r_en.capacity_score == r_ko.capacity_score
    assert r_en.willingness_bucket == r_ko.willingness_bucket
    assert r_en.capacity_bucket == r_ko.capacity_bucket
    assert r_en.persona_id == r_ko.persona_id
    assert r_en.flags == r_ko.flags
