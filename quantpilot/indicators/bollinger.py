...
def bollinger(
    ...
    *,
    ...
    Population standard deviation is used by default (``ddof=0``), matching
    common textbook Bollinger definitions.
    """
    if window < 1:
    ...
    std = prices.rolling_std(window_size=window, ddof=ddof)
